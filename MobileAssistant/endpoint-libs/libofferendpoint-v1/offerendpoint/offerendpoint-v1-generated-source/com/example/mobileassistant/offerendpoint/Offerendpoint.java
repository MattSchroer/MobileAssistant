 ...
 * on 2014-07-29 at 23:25:35 UTC 
 * Modify at your own risk.
 */

package com.example.mobileassistant.offerendpoint;
...
public class Offerendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetOffer extends OfferendpointRequest<com.example.mobileassistant.offerendpoint.model.Offer> {
    ...
    protected GetOffer(java.lang.String id) {
      super(Offerendpoint.this, "GET", REST_PATH, null, com.example.mobileassistant.offerendpoint.model.Offer.class);
   ...
   *
   * @param content the {@link com.example.mobileassistant.offerendpoint.model.Offer}
   * @return the request
   */
  public InsertOffer insertOffer(com.example.mobileassistant.offerendpoint.model.Offer content) throws java.io.IOException {
    InsertOffer result = new InsertOffer(content);
    initialize(result);
    return result;
  }

  public class InsertOffer extends OfferendpointRequest<com.example.mobileassistant.offerendpoint.model.Offer> {
     ...
     * @since 1.13
     */
    protected InsertOffer(com.example.mobileassistant.offerendpoint.model.Offer content) {
      super(Offerendpoint.this, "POST", REST_PATH, content, com.example.mobileassistant.offerendpoint.model.Offer.class);
    }
  ...
  public class ListOffer extends OfferendpointRequest<com.example.mobileassistant.offerendpoint.model.CollectionResponseOffer> {
     ...
     */
    protected ListOffer() {
      super(Offerendpoint.this, "GET", REST_PATH, null, com.example.mobileassistant.offerendpoint.model.CollectionResponseOffer.class);
    }
   ...
   * @return the request
   */
  public UpdateOffer updateOffer(com.example.mobileassistant.offerendpoint.model.Offer content) throws java.io.IOException {
    UpdateOffer result = new UpdateOffer(content);
    initialize(result);
    return result;
  }

  public class UpdateOffer extends OfferendpointRequest<com.example.mobileassistant.offerendpoint.model.Offer> {
     ...
     * @since 1.13
     */
    protected UpdateOffer(com.example.mobileassistant.offerendpoint.model.Offer content) {
      super(Offerendpoint.this, "PUT", REST_PATH, content, com.example.mobileassistant.offerendpoint.model.Offer.class);
    }
