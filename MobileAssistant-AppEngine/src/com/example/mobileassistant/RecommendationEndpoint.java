...
import com.example.mobileassistant.EMF;
...
@Api(name = "recommendationendpoint", namespace = @ApiNamespace(ownerDomain = "example.com", ownerName = "example.com", packagePath = "mobileassistant"))
